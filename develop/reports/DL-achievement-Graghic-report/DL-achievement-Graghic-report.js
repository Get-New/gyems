            ...
            success: function (data) {
                if (!data.Models || !data.Models.length) {
                    ...
                    for (var i = 0; i < item.length; i++) {
                        ...
                        that.allList.push(item[i].KpiReportName);
                        //that.allUnitName.push(item[i].UnitName);
                        that.allId.push(item[i].KpiReportID);

                        if (i < 1) {
                            that.selectedList.push(item[i].KpiReportName);
    ...
    ret.draw = function () {
        ...
        $(".cvs li").click(function () {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    KpiReportID:$('li.active').attr('itemid'),
