...
var locator = (function () {
    ...
    ret.init = function () {
        ...
        if (this.list.length == 0)
            throw new Error('参数modelbaseId无法获取');
...
var apiCaller = (function () {
    ...
    ret.get = function (callback) {
        ...
        $.ajax({
            url: '/api/ElectrolyticFlow/GetElectrolyticFlowSub',
            type: 'get',
...
function setkw(data) {
    setvalue($('#box1a .wsub .sub-value'), data.w, 'kw');
    setvalue($('#box1a .ksub .sub-value'), data.k);
}
