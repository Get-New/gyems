...
var apiCaller = (function () {
    ...
    ret.get = function (callback) {
        $.ajax({
            url: '/api/ElectrolyticFlow/GetGasFlowAll',
            type: 'get',
            dataType: 'json',
...
drawer.click(function (id) {
    window.location.href = '/develop/reports/energyImage/Gas-direction/Gas-directionSub.html?id0=' + id;
})
...
//绑定右键点击事件
function bindRClick() {
	$('.inner').on('contextmenu', function (e) {
	...
	$('.inner.link').on('contextmenu', function (e) {
		modelBaseId = $(this).attr('boxId');
		var modelBaseName = $(this).children(".title").html();
		var level = $(this).attr('level');
...
function calFlowDif(data) {
	...
	return data.w1 - subTotal;
}

function setkw(data) {
    setvalue($('#box1a .wsub .sub-value'), data.w1, 'Nm3/s');
    setvalue($('#box1a .ksub .sub-value'), data.k1, 'Nm3');
    setvalue($('#box1b .wsub .sub-value'), data.w2, 'Nm3/s');
    setvalue($('#box1b .ksub .sub-value'), data.k2, 'Nm3');
    setvalue($('#box2a .wsub .sub-value'), data.w3, 'Nm3/s');
    setvalue($('#box2a .ksub .sub-value'), data.k3, 'Nm3');
    setvalue($('#box2b .wsub .sub-value'), data.w4, 'Nm3/s');
    setvalue($('#box2b .ksub .sub-value'), data.k4, 'Nm3');
