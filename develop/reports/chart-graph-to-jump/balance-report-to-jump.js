...
function get_kpi_report(ModelBaseID, Cycle, Year, Month, Day) {
    var temp_data = null;
    $.ajax({
        url: '/api/OverView/GetBalanceReport',
        method: 'get',
        dataType: 'json',
        async: false,
...
function create_table(tableData) {
    ...
    tmpHeadFirst.append($("<th rowspan='1' colspan='1'>介质</th>"));
    tmpHeadFirst.append($("<th rowspan='1' colspan='1'>供给量</th>"));
    tmpHeadFirst.append($("<th rowspan='1' colspan='1'>消耗量</th>"));
    tmpHeadFirst.append($("<th rowspan='1' colspan='1'>差量</th>"));
    tmpHeadFirst.append($("<th rowspan='1' colspan='1'>平衡量</th>"));
