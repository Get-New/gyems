...
$(function () {
    ...
    Ext.onReady(function () {
        ...
        if (jumpDateType == 'Day') {
            options.defaultDateType = 'month';
        }
        else if (jumpDateType == 'Month') {
            options.defaultDateType = 'year';
        }
        else if (jumpDateType == 'Year') {
            options.defaultDateType = 'history';
        }
...
function get_cvs_by_e() {
    ...
    if (1) {
        $.ajax({
            ...
            dataType: 'json',
            async: false,
            data: { ModelBaseID: tree_about.current_tree_select_id, GetCurrentModelBase: true }, //, EnergyMediumId: $('#Medium-selector').val() },
            success: function (data) {
                if (!data.Models || !data.Models.length) {
                    return;
                }
...
function get_location_info() {
    ...
    //获得值jumpDateType
    jumpDateType = jumpMSG.split('DateType:')[1];
}