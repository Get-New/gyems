var Page = {
    ...
    my_grid_config: {
        ...
        url: '/api/StatisticsReportQuery/GetReportQuarterHourByModelbaseAndUnit',
    ...
    init: function () {
        ...
        $('#query').click(function () {
            that.my_grid.query({
                ...
                quarterhourend: $('#search-quarter1').val(),
                quarterhourbegin: $('#search-quarter2').val(),
            }, that.get_Models);
        });
    ...
    set_echarts_line: function (MeasureProperty_Name, UnitMeasure_Name, Name, Value) {
        ...
        //var min = 0; //parseInt(_.min(Value) * 0.1) * 10; //根据统计数据进行取整操作
        var option = {
            title: {
