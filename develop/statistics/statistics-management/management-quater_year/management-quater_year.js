var Page = {
    ...
    my_grid_config: {
        ...
        url: '/api/StatisticsReportQuery/GetReportQuarterYearByModelbaseAndUnit',
    ...
    init: function () {
            ...
            success: function (data) {
                if (_.isArray(data)) {
                    for (var i in data) {
                        ...
                        that.current_begintime = $('#search-quarter3').val();
                    }
                }
            }
        })
            ...
            success: function (data) {
                if (_.isArray(data)) {
                    for (var i in data) {
                        ...
                        that.current_begintime = $('#search-quarter4').val();
                    }
                }
            }
        })
        ...
        $('#query').click(function () {
            that.my_grid.query({
                ...
                quarteryearbegin: $('#search-quarter3').val(),
                quarteryearend: $('#search-quarter4').val(),
            });
        });
