var Page = {
    ...
    my_grid_config: {
        ...
        url: '/api/StatisticsReportQuery/GetReportQuarterHourByModelbase',
    ...
    init: function () {
        ...
        // 准备下拉框的数据源
        $.ajax({
            url: '/api/StatisticsReportQuery/GetQuarterHourList',
            type: 'get',
            dataType: 'json',
        ...
        $('#query').click(function () {
            ...
            var quarter = $('#search-quarter').val();
    ...
    tree_init: function () {
        ...
        $('#refresh').click(function () {
            ...
            that.my_grid.query({
                ModelBaseId: 'root',
                date: date,
                quarterhour: that.current_quarter
            });
        });
    },
