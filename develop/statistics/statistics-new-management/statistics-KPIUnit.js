var Page = {
    ...
    init: function () {
        ...
        this.prepare_select_source_UnitMeasure();
    ...
    //        return false;
    //    }
    //    Page.prepare_select_source_ProductUnit(ModelBaseId, EnergyMediumId);
    //},
    ...
    prepare_select_source_ProductUnit: function (ModelBaseID, ProductClassID, MeasurePropertyName) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i in MeasureProperty) {
                    var item = MeasureProperty[i];
                    var option = $('<option>').val(item.MeasurePropertyID).html('[' + item.MeasurePropertyName + '(' + item.ModelBaseName + ')]');
    ...
    // 显示单位 下拉框数据
    prepare_select_source_UnitMeasure: function () {
    ...
    tree_node_click: function (id, name) {
        ...
        this.prepare_select_source_Efficacious(id);
    },
    ...
    window_query: function () {
        ...
        Page.prepare_select_source_ProductUnit(ModelBaseID, ProductClassID, MeasurePropertyName);
    },
