var Page = {
    ...
    my_grid_config: {
        ...
        url: '/api/EngeryMeasureProperty/GetForecastUnit',
    ...
    prepare_select_source_MeasurePropertyName: function (ModelBaseID, EnergyMediumID, MeasurePropertyName) {
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: 'json',
            data: { ModelBaseID: ModelBaseID, EnergyMediumId: EnergyMediumID, MeasurePropertyTypes: '5,7', MeasurePropertyName: MeasurePropertyName },
            success: function (data) {
    ...
    //弹出框 产品计划 的下拉框数据
    prepare_select_source_ProductUnit: function (ModelBaseID, ProductClassID) {
    ...
    window_query: function () {
        ...
        Page.prepare_select_source_ProductUnit(ModelBaseId, ProductClassID);
    },
