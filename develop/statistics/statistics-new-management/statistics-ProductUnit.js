var Page = {
    ...
    // 准备产品种类的下拉框数据
    prepare_select_source_ProductClass: function () {
    ...
    //弹出框 统计单元的下拉框数据
    prepare_select_source_ProductUnit: function (ModelBaseID, ProductClassID, MeasurePropertyName) {
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: 'json',
            data: { ModelBaseID: ModelBaseID, ProductClassId: ProductClassID, MeasurePropertyName: MeasurePropertyName },
            success: function (data) {
    ...
    //计划单元 下拉框数据
    prepare_select_source_ProductUnitPlan: function (ModelBaseID, ProductClassID) {
        $('#RelativeTargetID').val('').html('');
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: 'json',
            data: { ModelBaseID: ModelBaseID, ProductClassId: ProductClassID, MeasurePropertyTypes: '7' },
            success: function (data) {
                var MeasureProperty = data.Models;
    ...
    on_grid_row_selected: function (data, index) {
        ...
        //this.prepare_select_source_ProductUnitPlan(data.ModelBaseID, '');
    ...
    tree_node_click: function (id, name) {
        ...
        this.prepare_select_source_ProductUnitPlan(id, '');
    },
    ...
    window_query: function () {
        ...
        Page.prepare_select_source_ProductUnit(ModelBaseId, EnergyMediumId, MeasurePropertyName);
        //Page.prepare_select_source_MeterPointID(ModelBaseId, EnergyMediumId);
    },
