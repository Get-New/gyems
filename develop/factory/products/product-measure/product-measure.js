var Page = {
    ...
    my_grid_config: function () {
        return {
            ...
            url: '/api/ProductClassMeasure/GetPage',
            ps: 0, // 0表示不进行分页
    ...
    on_grid_row_delete_clicked: function (record) {
        ...
        var that = this;
        var data = { ProductMeasureID: record.ProductMeasureID };

        Util.ajax_delete({
            data: data,
            model: 'ProductClassMeasure',
