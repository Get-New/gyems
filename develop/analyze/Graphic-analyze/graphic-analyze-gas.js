...
var currType, currYear, currMonth, currDay;
...
var dst = (function () {
    ...
    ret.init = function () {
        ...
        $('#year').click(function () { switchYear(); })
        $('#month').click(function () { switchMonth(); })
        $('#day').click(function () { switchDay(); })
        $('#pre').click(function () { preOrNext(-1); })
        $('#next').click(function () { preOrNext(1); })
