            ...
            if (type == 'day') {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        line_base.push({ name: '电解车间净化水单耗', type: 'line', data: line_datat1, markLine: { silent: true, data: [{ yAxis: maxx }] }, label: { normal: { show: true } } })

                        that.draw_line_charts('电解车间净化水单耗', line_axis_data, line_base, maxx)
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            data: {
                                EnergymediumId: '1d22868d969c094A27bc86aa',
            ...
            success: function (data_l1) {
                $.ajax({
                    ...
                    success: function (data_l2) {
                        ...
                        line_base.push({ name: '一系统净化水单耗', type: 'line', data: line_datat1, markLine: { silent: true, data: [{ yAxis: item[0].BaseLine }] }, label: { normal: { show: true } } })
                        Page.draw_line_charts2('一系统净化水单耗', line_axis_data, line_base, maxx)
                        ...
                        line_base2.push({ name: '二系统净化水单耗', type: 'line', data: line_datat12, markLine: { silent: true, data: [{ yAxis: item2[0].BaseLine }] }, label: { normal: { show: true } } })
                        Page.draw_line_charts3('二系统净化水单耗', line_axis_data2, line_base2, maxx2)
