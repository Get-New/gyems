...
var Page = {
	...
	init: function () {
		...
		$('#query').click(function () {
			that.my_grid.query({ EfficaciousId: that.current_tree_select_id, EfficaciousType: '绩效报警' });
			that.clear();
		});
		...
		$('#export').click(function () {
			that.my_grid.exportExcel('能源绩效管理');
		})
	...
	get_effect_history: function (id) {
		...
		$.ajax({
			...
			dataType: 'json',
			async: false,
			data: { EfficaciousId: id, DescriptionInfo: ',报警上限,报警下限' },
	...
	tree_config: {
		url: '/api/BasicEfficacious/GetTree?EfficaciousType=' + escape('绩效报警'),
		root_name: '绩效报警单元',
	...
	tree_init: function () {
		...
		$('#refresh').click(function () {
			...
			that.my_grid.query({ EfficaciousId: '', EfficaciousType: '绩效报警' });
		});
	},
	...
	tree_node_click: function (id, name) {
		...
		this.my_grid.query({ EfficaciousId: id, EfficaciousType: '绩效报警' });
	}
}