var Page = {
    ...
    init: function () {
        ...
        if (Page.current_MeasurePropertyType == '7') {
            temp_my_grid_config.url = '/api/ReportDataCopy/QueryDayCopy';
            this.my_grid = new MyGrid(this, temp_my_grid_config);
        }
        else {
            temp_my_grid_config.url = '/api/ReportDataCopy/QueryDayReport';
            this.my_grid = new MyGrid(this, temp_my_grid_config);
        }
    ...
    submit_edit: function () {
        ...
        $.ajax({
            url: '/api/ReportDataCopy/EditDay',
            method: 'put',
            dataType: 'json',
            async: false,
            data: data,
