...
var Page = {
    ...
    init: function () {
        ...
        $('#query').click(function () {
            that.my_grid.query({ EfficaciousId: that.current_tree_select_id, EfficaciousType: '价格系数' });
            that.clear();
        });
        ...
        $('#submit-add').click(function () {
            that.current_tree_select_id = that.current_tree_select_id || $('#EfficaciousId').val();
        ...
        $('#export').click(function () {
            that.my_grid.exportExcel('能源价格管理');
        })
    ...
    tree_config: {
        url: '/api/BasicEfficacious/GetTree?EfficaciousType=' + escape('价格系数'),
        root_name: '价格单元',
    ...
    tree_init: function () {
        ...
        $('#refresh').click(function () {
            ...
            that.my_grid.query({ EfficaciousId: '', EfficaciousType: '价格系数' });
        });
    },
    ...
    tree_node_click: function (id, name) {
        ...
        this.my_grid.query({ EfficaciousId: id, EfficaciousType: '价格系数' });
    }
}