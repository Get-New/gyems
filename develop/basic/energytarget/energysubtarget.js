...
var Page = {
        ...
        return {
            ...
            grid_config: {
                ...
                columns: {
                    ...
                    //{
                    //    text: '国家标准',
                    //    dataIndex: 'SubefficaciousUpper',
                    //    width: 200
                    //}, {
                    //    text: '厂内标准',
                    //    dataIndex: 'SubefficaciousLower',
                    //    width: 200
                    //},
                    {
                        text: '绩效单位',
            ...
            url: '/api/BasicSubefficacious/GetPageWithFactory',
            ps: 8,
    ...
    init: function () {
        ...
        $('#query').click(function () {
            that.my_grid.query({ EfficaciousId: that.current_tree_select_id, EfficaciousType: '绩效系数' });
            that.clear();
        });
        ...
        $('#export').click(function () {
            that.my_grid.exportExcel('绩效目标管理');
        })
    ...
    get_effect_history: function (id) {
        var temp_data = null;
        $.ajax({
            url: '/api/BasicSubefficacious/GetMultiHistory',
            method: 'get',
            dataType: 'json',
            async: false,
            //data: { EfficaciousId: id, DescriptionInfo: '绩效目标,国家标准,厂内标准' },
            data: { EfficaciousId: id, DescriptionInfo: '绩效目标' },
    ...
    tree_config: {
        url: '/api/BasicEfficacious/GetTree?EfficaciousType=' + escape('绩效系数'),
        root_name: '绩效单元',
    ...
    tree_init: function () {
        ...
        $('#refresh').click(function () {
            ...
            that.my_grid.query({ EfficaciousId: '', EfficaciousType: '绩效系数' });
        });
    },
    ...
    tree_node_click: function (id, name) {
        ...
        this.my_grid.query({ EfficaciousId: id, EfficaciousType: '绩效系数' });
    }
}