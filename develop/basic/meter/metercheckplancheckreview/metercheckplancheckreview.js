var Page = {
    ...
    my_grid_config: function () {
        return {
            ...
            url: '/api/MeterCheckPlanCheck/Review',
    ...
    init: function () {
        ...
        $('#submit-edit').click(function () {
            if (Page.current_grid_select_MeterCheckRecordID == null) {
                Util.alert('该计划未执行，不允许审核');
                return false;
            }
            else {
                that.submit_edit();
        ...
        $('#export').click(function () {
            that.my_grid.exportExcel('执行结果审核');
        })
    ...
    validate: function (data) {
        if (!data.MeterCheckPlanCheckReview) {
            return "请选审核结果";
        }
    },
    ...
    on_grid_row_selected: function (data, index) {
        ...
        Page.current_grid_select_MeterCheckRecordID = data.MeterCheckRecordID;
    },
