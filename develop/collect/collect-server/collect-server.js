...
var Page = {
    ...
    my_grid_config: {                                   
        ...
        url: '/api/MeterDatasource/GetPage',
        ps: 11,
    ...
    init: function () {                                         
        ...
        $('#query').click(function () {
            that.my_grid.query({ DataSourceName: $('#search-name').val() });
            that.clear();
        ...
        that.my_grid.query({ DataSourceName: '' });
        ...
        $('#export').click(function () {
            that.my_grid.exportExcel('数据源管理');
        })
    ...
    on_grid_row_delete_clicked: function (record) {
        var that = this;
        var data = { DataSourceID: record.DataSourceID };
        Util.confirm('确认要删除名称为' + record.DataSourceName + '的记录吗?', function () {
            $.ajax({
                url: '/api/MeterDatasource/Delete',
                type: 'delete',
                data: data,
                success: function (data) {
